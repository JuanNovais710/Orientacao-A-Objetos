...
public class ReporEstoqueProduto {
    public static void main(String[] args) {
        ...
        System.out.print("Quantas " + produto.nome + " existem no estoque? ");
        produto.quantidadeEmEstoque = scanner.nextInt();
        System.out.println("A quantidade de " + produto.nome + " no estoque é: " + produto.quantidadeEmEstoque + ". Necessário repor? " + necessarioReporEstoque(produto));
    }
