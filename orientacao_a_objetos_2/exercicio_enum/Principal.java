package com.company.orientacao_a_objetos_2.exercicio_enum;
/*
...
public class Principal {
    public static void main(String[] args) {
        ...
        conta1.setFornecedor(mercado);
        ContaAPagar conta2 = new ContaAPagar("Compras do mês", mercado, 390d, "19/05/2012");
        ContaAPagar conta3 = new ContaAPagar("Aluguel da filial", imobiliaria, 700d, "11/05/2012");
        // pagamento de conta pendente (ok, deve funcionar)
        conta1.pagar();
        // tentativa de pagar uma conta cancelada (não deve aceitar pagamento)
        conta2.cancelar();
