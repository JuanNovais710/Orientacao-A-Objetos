...
Feito isso, mostre todas essas propriedades no console.
Não esqueça de encapsular cada propriedade antes de exibir os dados no console. Isso é para que você não use as variáveis diretamente e sim os métodos getters e setters.
...
public class VendasConsole {
    public static void main(String[] args) {
        ...
        pedido.setSubtotal(1000.00);
        pedido.setDesconto(0.1);
        System.out.println("Código do pedido: " + pedido.getCodigo());
        System.out.println("Valor sem desconto do pedido: " + pedido.getSubtotal());
        System.out.println("Total de desconto: " + pedido.getDesconto());
        System.out.println("Valor final do pedido: " + pedido.getTotal());
    }
}
