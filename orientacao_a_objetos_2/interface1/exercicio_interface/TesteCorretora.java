...
3. Se Carro diz que implementa a interface Seguravel, ela deve implementar todos os métodos especificados na interface, pois uma interface é um contrato, ou seja,
a classe deve garantir que faz o que ela pede.
...
public class TesteCorretora {
    public static void main(String[] args) {
        CorretoraSeguros tioZe = new CorretoraSeguros();
        Carro carro = new Carro("Palio", 20000.0);
